                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="/os/editar/<?php echo htmlspecialchars($order['id']); ?>" 
                                                ...
                                                <button type="button" 
                                                        ...
                                                        onclick="confirmDelete(<?php echo htmlspecialchars($order['id']); ?>)"
                                                        title="Excluir">
...
$(document).ready(function() {
    // Handler para o formulário de exclusão
    $('#deleteForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                alert('Erro ao excluir a ordem de serviço. Por favor, tente novamente.');
