        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="/os">Ordens de Serviço</a></li>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form id="serviceOrderForm" method="post" action="/os/<?= $order['id'] ?>" class="needs-validation" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-3 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                                            <label class="btn btn-outline-success <?= $order['priority'] == 'low' ? 'active' : '' ?>">
                                                <input type="radio" name="priority" value="low" <?= $order['priority'] == 'low' ? 'checked' : '' ?>> Baixa
                                            </label>
                                            <label class="btn btn-outline-warning <?= $order['priority'] == 'medium' ? 'active' : '' ?>">
                                                <input type="radio" name="priority" value="medium" <?= $order['priority'] == 'medium' ? 'checked' : '' ?>> Média
                                            </label>
                                            <label class="btn btn-outline-danger <?= $order['priority'] == 'high' ? 'active' : '' ?>">
                                                <input type="radio" name="priority" value="high" <?= $order['priority'] == 'high' ? 'checked' : '' ?>> Alta
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="descricao" name="descricao" rows="3"><?= htmlspecialchars($order['description']) ?></textarea>
                                    </div>
                                </div>
                            </div>
